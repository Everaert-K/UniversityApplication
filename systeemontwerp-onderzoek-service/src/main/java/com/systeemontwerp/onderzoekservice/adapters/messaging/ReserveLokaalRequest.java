...
public class ReserveLokaalRequest {
	...
	public ReserveLokaalRequest(String id, String profId, String lokaalId, LocalDate date, Time time, ReserveringType type, List<String> hourIds) {
		this.id = id;
		this.profId = profId;
