...
public class CheckHoursLokaalResponse {
	...
	public CheckHoursLokaalResponse(String id, String profId, String lokaalId, LocalDate date, Time time, ReserveringType type, String status, List<String> hourIds) {
		this.id = id;
		this.profId = profId;
